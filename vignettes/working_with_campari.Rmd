...
```{r, eval=FALSE}
options(CampaRi.data_management = "netcdf") # R handling !!! ATTENTION MEMORY PROBLEMS ARE POSSIBLE FOR BIG DATA-SETS (USE NETCDF HANDLING)
adjl <- mst_from_trj(trj = trj[1:1000,], mode = "fortran", normalize_d = FALSE, logging = F) # this will fail because it has a "safe" limit of 25000 snapshots
