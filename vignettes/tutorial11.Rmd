...
#gg <- sapphire_plot('REPIX_000000000010.dat', return_plot = TRUE, local_cut = FALSE, ann_trace = 1:6000, 
#                     rescaling_ann_col=F, specific_palette_annotation= c("#b47b00", "#000000"), specific_palette_timeline= c("#000000"), timeline = T) 
