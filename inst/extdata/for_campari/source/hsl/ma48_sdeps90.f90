...
MODULE hsl_zb01_single
   ...
   INTERFACE zb01_resize1
      MODULE PROCEDURE zb01_resize1_single
   END INTERFACE

   INTERFACE zb01_resize2
      MODULE PROCEDURE zb01_resize2_single
   END INTERFACE
...
SUBROUTINE zb01_resize1_single(w,size_in,size_out,info,src,dest,filename, &
      file_size,mode)
...
END SUBROUTINE zb01_resize1_single

! ---------------------------------------------------------------

SUBROUTINE zb01_resize2_single(w,size_in,size_out,info,src,dest,filename, &
      file_size,mode)
...
END SUBROUTINE zb01_resize2_single
