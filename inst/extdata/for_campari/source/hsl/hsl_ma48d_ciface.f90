...
subroutine ma48_default_control_d(ccontrol) bind(C)
   use hsl_ma48_double_ciface
   implicit none
...
end subroutine ma48_default_control_d

subroutine ma48_initialize_d (cfactors) bind(C)
   use hsl_ma48_double_ciface
   implicit none
...
end subroutine ma48_initialize_d

subroutine ma48_analyse_d (m, n, ne, crow, ccol, cval, cfactors, &
...
end subroutine ma48_analyse_d

subroutine ma48_factorize_d(m, n, ne, crow, ccol, cval, cfactors, &
...
end subroutine ma48_factorize_d

subroutine ma48_solve_d (m, n, ne, crow, ccol, cval, cfactors, crhs, &
   ...
   ! Copy data out
   call copy_sinfo_out(fsinfo, csinfo)
end subroutine ma48_solve_d

integer(C_INT) function ma48_finalize_d (cfactors, ccontrol) bind(C)
   use hsl_ma48_double_ciface
   implicit none
   ...
   ! Call the Fortran routine
   call f_ma48_finalize(ffactors, fcontrol, ma48_finalize_d)

   ! Free memory
   deallocate(ffactors)
   cfactors = C_NULL_PTR

end function ma48_finalize_d

integer(C_INT) function ma48_determinant_d (cfactors, sgndet, logdet, &
      ccontrol) bind(C)
   use hsl_ma48_double_ciface
   implicit none
...
end function ma48_determinant_d

integer(C_INT) function ma48_special_rows_and_cols_d (cfactors, rank, crows, &
   ...
   call f_ma48_special_rows_and_cols(ffactors, rank, frows, fcols, &
      fcontrol, ma48_special_rows_and_cols_d)
...
end function ma48_special_rows_and_cols_d
