...
! write temp hists to track progress (these recycle due to two digits used)
  ...
  if (use_MPIAVG.EQV..true.) then
    ...
    fn =  'N_'//nod(1:re_aux(10))//bname(t1:t2)//'_'//xpont(1:slen)
    fn2 = 'N_'//nod(1:re_aux(10))//bname(t1:t2)//'H_'//xpont(1:slen)
  end if
#else
  fn =   bname(t1:t2)//'_'//xpont(1:slen)
  fn2 =  bname(t1:t2)//'H_'//xpont(1:slen)
...
! Write final G to file
  ...
  if (use_MPIAVG.EQV..true.) then
    ...
    call int2str(myrank,nod,re_aux(10))
    fn =  'N_'//nod(1:re_aux(10))//'_WANGLANDAU_G.dat'
    fn2 = 'N_'//nod(1:re_aux(10))//'_WANGLANDAU_GH.dat'
  end if
#else
  fn =  'WANGLANDAU_G.dat'
  fn2 = 'WANGLANDAU_GH.dat'
