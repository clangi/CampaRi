...
!
  ...
  if (use_REMC.EQV..true.) then
    if (myrank.eq.0) then
      ...
      fnam =  'N_'//xpont(1:re_aux(10))//'_INTERNAL_COORDS.idx'
    else
      return
    end if
  else if (use_MPIAVG.EQV..true.) then
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,xpont,re_aux(10))
    raspec =  'N_'//xpont(1:re_aux(10))//'_RAMACHANDRAN.dat'
  else if (use_MPIAVG.EQV..true.) then
...
!
  ...
  do rr=1,nrspecrama
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      raspec =  'N_'//xpont(1:re_aux(10))//'_RESRAMA_'//&
 &string(1:lext)//'.dat'
    else if (use_MPIAVG.EQV..true.) then
...
!
  do rr=1,nrmolrama
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      raspec =  'N_'//xpont(1:re_aux(10))//'_MOLRAMA_'//&
 &string(1:lext)//'.dat'
    else if (use_MPIAVG.EQV..true.) then
...
!
  if (sum(jccnt).gt.0) then
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      raspec =  'N_'//xpont(1:re_aux(10))//'_JCOUPLING.dat'
    else if (use_MPIAVG.EQV..true.) then
...
!
  if (do_ints(1).EQV..true.) then
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      fnm =  'N_'//xpont(1:re_aux(10))//'_INTHISTS_BL.dat'
    else if (use_MPIAVG.EQV..true.) then
      fnm = 'INTHISTS_BL.dat'
    end if
#else
...
!
  if (do_ints(2).EQV..true.) then
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      fnm =  'N_'//xpont(1:re_aux(10))//'_INTHISTS_BA.dat'
    else if (use_MPIAVG.EQV..true.) then
      fnm = 'INTHISTS_BA.dat'
    end if
#else
...
!
  if (do_ints(3).EQV..true.) then
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      fnm =  'N_'//xpont(1:re_aux(10))//'_INTHISTS_IM.dat'
    else if (use_MPIAVG.EQV..true.) then
      fnm = 'INTHISTS_IM.dat'
    end if
#else
...
!
  if (do_ints(4).EQV..true.) then
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      fnm =  'N_'//xpont(1:re_aux(10))//'_INTHISTS_DI.dat'
    else if (use_MPIAVG.EQV..true.) then
      fnm = 'INTHISTS_DI.dat'
    end if
#else
...
!
  if (use_frame_weights.EQV..false.) then
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      fn =  'N_'//xpont(1:re_aux(10))//'_BB_SEGMENTS_RES.dat'
    else if (use_MPIAVG.EQV..true.) then
...
! provide normalized values
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,xpont,re_aux(10))
    fn =  'N_'//xpont(1:re_aux(10))//'_BB_SEGMENTS_NORM_RES.dat'
  else if (use_MPIAVG.EQV..true.) then
...
!
  if (use_frame_weights.EQV..false.) then
    ...
    if (use_REMC.EQV..true.) then
      call int2str(myrank,xpont,re_aux(10))
      fn =  'N_'//xpont(1:re_aux(10))//'_BB_SEGMENTS.dat'
    else if (use_MPIAVG.EQV..true.) then
      fn = 'BB_SEGMENTS.dat'
    end if
#else
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,xpont,re_aux(10))
    fn =  'N_'//xpont(1:re_aux(10))//'_BB_SEGMENTS_NORM.dat'
  else if (use_MPIAVG.EQV..true.) then
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,xpont,re_aux(10))
    fn =  'N_'//xpont(1:re_aux(10))//'_ZSEC_HIST.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'ZSEC_HIST.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,xpont,re_aux(10))
    fn =  'N_'//xpont(1:re_aux(10))//'_ZAB_2DHIST.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'ZAB_2DHIST.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,xpont,re_aux(10))
    fn =  'N_'//xpont(1:re_aux(10))//'_ZBETA_RG.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'ZBETA_RG.dat'
  end if
#else
