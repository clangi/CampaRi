...
!
 94   format(i10,6(1x,g14.7))
  ...
  if (use_REMC.EQV..true.) then
    ...
    fn =  'N_'//xpont(1:re_aux(10))//'_TURNS_RES.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'TURNS_RES.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    ...
    fn = 'N_'//nod(1:re_aux(10))//'_POLYAVG.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'POLYAVG.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,nod,re_aux(10))
    fn = 'N_'//nod(1:re_aux(10))//'_RDHIST.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'RDHIST.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,nod,re_aux(10))
    fn = 'N_'//nod(1:re_aux(10))//'_RETEHIST.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'RETEHIST.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,nod,re_aux(10))
    fn = 'N_'//nod(1:re_aux(10))//'_RGHIST.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'RGHIST.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,nod,re_aux(10))
    fn = 'N_'//nod(1:re_aux(10))//'_DENSPROF.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'DENSPROF.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,nod,re_aux(10))
    fn = 'N_'//nod(1:re_aux(10))//'_INTSCAL.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'INTSCAL.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,nod,re_aux(10))
    fn = 'N_'//nod(1:re_aux(10))//'_KRATKY.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'KRATKY.dat'
  end if
#else
...
!
  ...
  if (use_REMC.EQV..true.) then
    call int2str(myrank,nod,re_aux(10))
    fn = 'N_'//nod(1:re_aux(10))//'_DIFFRACTION.dat'
  else if (use_MPIAVG.EQV..true.) then
    fn = 'DIFFRACTION.dat'
  end if
#else
