...
!
  ...
  align%mmol = 0
  pdb_fileformat = 1
  pdb_formstr(1) = "a6,i5,1x,a4,a1,a3,1x,a1,i4,4x,3f8.3"
  pdb_formstr(2) = "a6,a5,1x,a4,a1,a3,1x,a1,i4,4x,3f8.3"
  pdb_mpimany = .false.
...
!
  ...
  ncdm_doasconv = .false.         !do not perform ascii conversion
  ...
  ncdm_nm_feats = 'featuresvals'  !my preferred name for array cludata in net-cdf file
  ncdm_docheck_r = .false.        !no debug output
  ncdm_periodic_rng(1) = -180     !left margin of periodicity interval
  ncdm_periodic_rng(1) =  180     !right margin of periodicity interval
