...
!
 ...
 &brklnk_report
  ...
  RTYPE cradius,cmaxrad,chardcut,cdynwbuf,cequilbuf,caddlinks,caddlinkwt,cmergecrit,arntol
  character(MAXSTRLEN) cfilen,nblfilen,tbrkfilen,tlnkfilen,clufilen
  logical read_nbl_from_nc,align_for_clustering,refine_clustering,remap_trajlnks
  logical tmat_report,doeigvec_msm,dopfold,dopfoldminus,pfold_report
