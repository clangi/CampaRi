# Contributing to CampaRi development

__adapted from ggplot2__


The goal of this guide is to help you get up and contributing to CampaRi as quickly as possible. The guide is divided into two main pieces:

1. Filing a bug report or feature request in an issue.
1. Suggesting a change via a pull request.

Before any issues and pull request (PR) please check the original documentation of the CAMPARI software [here](http://campari.sourceforge.net/documentation.html)
...
1.  If you're adding new parameters or a new function, you'll also need
    ...
    Currently, CampaRi uses the development version of roxygen2, which you
    can get from CRAN.

<!--
1.  If fixing a bug or adding a new feature to a non-graphical function,
    please add a [testthat](https://github.com/hadley/testthat) unit test (NOT READY).
